...
class CollectionManager:
    def fetch(
        self, col_uid: str, fetch_options: t.Optional[FetchOptions]
    ) -> "Collection": ...
    def create(
        self, collection_type: str, meta: ItemMetadata, content: bytes
    ) -> "Collection": ...
    def create_raw(
        self, collection_type: str, meta: bytes, content: bytes
    ) -> "Collection": ...
    def get_item_manager(self, col: "Collection") -> "ItemManager": ...
    def list(
        self, collection_type: str, fetch_options: t.Optional[FetchOptions]
    ) -> CollectionListResponse: ...
    def list_multi(
        self, collection_types: t.List[str], fetch_options: t.Optional[FetchOptions]
    ) -> CollectionListResponse: ...
    def upload(
        self, collection: "Collection", fetch_options: t.Optional[FetchOptions]
    ): ...
    def transaction(
        self, collection: "Collection", fetch_options: t.Optional[FetchOptions]
    ): ...
...
class ItemManager:
    def fetch(
        self, item_uid: str, fetch_options: t.Optional[FetchOptions]
    ) -> "Item": ...
    ...
    def item_revisions(
        self, item: "Item", fetch_options: t.Optional[FetchOptions]
    ) -> ItemRevisionsListResponse: ...
    def fetch_updates(
        self, items: t.List["Item"], fetch_options: t.Optional[FetchOptions]
    ) -> ItemListResponse: ...
    def fetch_multi(
        self, items: t.List[str], fetch_options: t.Optional[FetchOptions]
    ) -> ItemListResponse: ...
    def batch(
        self,
        items: t.List["Item"],
        deps: t.Optional[t.List["Item"]],
        fetch_options: t.Optional[FetchOptions],
    ): ...
    def transaction(
        self,
        items: t.List["Item"],
...
class CollectionInvitationManager:
    def list_incoming(
        self, options: t.Optional[FetchOptions]
...
class CollectionMemberManager:
    ...
    def modify_access_level(
        self, username: str, access_level: CollectionAccessLevel
    ): ...
